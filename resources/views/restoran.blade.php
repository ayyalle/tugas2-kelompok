    ...
    @foreach($restaurants as $restaurant)
        ...
        ">
            ...
            <div style="padding: 22px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                        ...
                        <span style="
                            ...
                            font-weight: 700;
                        ">
                            Rp{{ number_format($restaurant->price ?? 0, 0, ',', '.') }}
                        </span>
                    </div>
                ...
                @if(auth()->check() && auth()->user()->role === 'admin')
                    <form action="{{ route('restaurant.destroy', $restaurant->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus restoran ini?')" style="margin-top: 10px;">
                        @csrf
                        @method('DELETE')
